<template>
  <v-container>
    <p>
      <strong><h1 style="textAlign: center">Datenschutzerklärung</h1></strong>
    </p>
    ...
    <p>
      <span id="s3-t-firma">Name der Firma</span><br /><span
        id="s3-t-ansprechpartner"
        >Ansprechpartner</span
      ><br /><span id="s3-t-strasse">Straße und Hausnummer</span><br /><span
        id="s3-t-plz"
        >PLZ</span
      >
    ...
    <p>
      ...
      Webbrowser auf Ihrem Endgerät speichert und eine Analyse der
      Website-Benutzung ermöglichen. Mittels Cookie erzeugte Informationen über
      Ihre Benutzung unserer Website werden an einen Server von Google
    ...
    <p>
      ...
      Google die volle IP-Adresse an einen Server in den USA überträgt und dort
      kürzt. In unserem Auftrag wird Google diese Informationen benutzen, um
      Ihre Nutzung der Website auszuwerten, um Reports über Websiteaktivitäten
    ...
    <p>
      ...
      Ebenso können Sie die Erfassung von Daten bezüglich Ihrer Website-Nutzung
      einschließlich Ihrer IP-Adresse mitsamt anschließender Verarbeitung durch
    ...
    <p>
      ...
      der die Erfassung Ihrer Daten bei zukünftigen Besuchen unserer Website
      verhindert: Google Analytics deaktivieren.
    </p>
    <p>
      Einzelheiten zum Umgang mit Nutzerdaten bei Google Analytics finden Sie in
    ...
    <p>
      Zur vollständigen Erfüllung der gesetzlichen Datenschutzvorgaben haben wir
    ...
    <p>
      ...
      von Drittanbietern. Eine Zuordnung der Daten zu einer bestimmten Person
      ist nicht möglich. Sie können diese Funktion jederzeit deaktivieren. Dies
      ist über die Anzeigeneinstellungen in Ihrem Google-Konto möglich oder
      indem Sie die Erfassung Ihrer Daten durch Google Analytics, wie im Punkt
      “Widerspruch gegen die Datenerfassung” erläutert, generell untersagen.
    </p>
    <p>
      <small
